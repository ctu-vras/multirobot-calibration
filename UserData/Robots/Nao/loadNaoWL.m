...
%     WL.leftIndex = zeros(3,6);
%     WL.rightIndex = zeros(3,6);
%     WL.leftMiddle = zeros(3,6);
%     WL.rightMiddle = zeros(3,6);
%     WL.leftThumb = zeros(2,6);
%     WL.rightThumb = zeros(2,6);
%     WL.leftFinger = [1,1,1,0,0,0];
%     WL.rightFinger = [1,1,1,0,0,0];
end