function datasets = loadDatasetNaoCoefOut(robot,optim, chains, varargin)
...
%         end
        ...
        taxelStruct=prepareDataCoefOut(robot,datasetsNames{name},chain1,chain2,DH,alt,chains, optim);
        %Init dataset 
