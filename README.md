...
Recommended steps (the order is optional):
 - [Download the toolbox and additional files](https://gitlab.fel.cvut.cz/body-schema/code-calib-multirobot/-/tags) (Configuration file pattern, Robot function pattern, Example codes, csv file pattern) - **always download the lastest release!**
