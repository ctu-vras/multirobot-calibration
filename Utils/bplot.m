...
if horizontalFlag
    hReg2(end+1) =  patch('XData',[boxEdge(1), boxEdge(1), boxEdge(1)+IQR, boxEdge(1)+IQR], ...
    'YData', [y-barWidth/2, y+barWidth/2, y+barWidth/2, y-barWidth/2],'linewidth',linewidth,'EdgeColor',boxColor,'facecolor',[1 1 1]);
    ...
    hReg2(end+1) =  patch('YData',[boxEdge(1), boxEdge(1), boxEdge(1)+IQR, boxEdge(1)+IQR], ...
    'XData', [y-barWidth/2, y+barWidth/2, y+barWidth/2, y-barWidth/2],'linewidth',linewidth,'EdgeColor',boxColor,'facecolor',[1 1 1]);
