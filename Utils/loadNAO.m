...
%     %optProperties.triangles.t27.optimize=true; % Turn on one given triangle
    ...
    structure={{'base',types.base,nan,0,0,group.torso},...
        ...
        ...
        {'headPlastic',types.mount,4,1,1,group.headSkin},...
        {'headLeftPatch',types.patch,5,2,1,group.headSkin},...
        {'headRightPatch',types.patch,5,3,1,group.headSkin},...
        ...
        ...
        ...
        {'leftPlastic',types.mount,13,1,1,group.leftArmSkin},...
        {'leftUpperPatch',types.patch,14,2,1,group.leftArmSkin},...
        {'leftLowerPatch',types.patch,14,3,1,group.leftArmSkin},...
        ...
        ...
        ...
        {'rightPlastic',types.mount,22,1,1,group.rightArmSkin},...
        {'rightUpperPatch',types.patch,23,2,1,group.rightArmSkin},...
        {'rightLowerPatch',types.patch,23,3,1,group.rightArmSkin},...
        ...
        {'torsoPlastic',types.mount,1,1,1,group.torsoSkin},...
        {'torsoLeftPatch',types.patch,26,2,1,group.torsoSkin},...
        {'torsoRightPatch',types.patch,26,3,1,group.torsoSkin}};
    for triangleId=1:size(hands_upper,2)
        structure{end+1}={strcat('rightTriangle',num2str(hands_upper(triangleId))),types.triangle,24,triangleId+3,1,group.rightArmSkin};
        structure{end+1}={strcat('leftTriangle',num2str(hands_upper(triangleId))),types.triangle,15,triangleId+3,1,group.leftArmSkin};
    end
    for triangleId=1:size(hands_lower,2)
        structure{end+1}={strcat('rightTriangle',num2str(hands_lower(triangleId))),types.triangle,25,triangleId+3+size(hands_upper,2),1,group.rightArmSkin};
        structure{end+1}={strcat('leftTriangle',num2str(hands_lower(triangleId))),types.triangle,16,triangleId+3+size(hands_upper,2),1,group.leftArmSkin};
    end
    for triangleId=1:size(head_left,2)
        structure{end+1}={strcat('headTriangle',num2str(head_left(triangleId))),types.triangle,6,triangleId+3,1,group.headSkin};
    end
    for triangleId=1:size(head_right,2)
        structure{end+1}={strcat('headTriangle',num2str(head_right(triangleId))),types.triangle,7,triangleId+3+size(head_left,2),1,group.headSkin};
    end
    for triangleId=1:size(torso_left,2)
        structure{end+1}={strcat('torsoTriangle',num2str(torso_left(triangleId))),types.triangle,27,triangleId+3,1,group.torsoSkin};
    end
    for triangleId=1:size(torso_right,2)
        structure{end+1}={strcat('torsoTriangle',num2str(torso_right(triangleId))),types.triangle,28,triangleId+3+size(torso_left,2),1,group.torsoSkin};
    end
