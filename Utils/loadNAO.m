...
%     optProperties.triangles.perturbations=[0,0,0,0];%a,d,alpha,theta/x,y,z,~
    ...
    structure={{'base',types.base,nan,[0 0 0 0],0,group.torso},...
        ...
        {'headEE',types.joint,3,[0,0,0,0],0,group.head},...
        ...
        {'headPlastic',types.mount,4,[0,0,0,0],1,group.head},...
        {'headLeftPatch',types.patch,5,[0,0,0,0],1,group.head},...
        {'headRightPatch',types.patch,5,[0,0,0,0],1,group.head},...
        ...
        {'leftShoulderPitch',types.joint,1,[0,  0.1, -pi/2,  0],0,group.leftArm},...
        {'leftShoulderRoll',types.joint,8,[0, 0.098, pi/2, 0],0,group.leftArm},...
        {'leftElbowYaw',types.joint,9,[0, 0, pi/2, pi/2],0,group.leftArm},...
        {'leftElbowRoll',types.joint,10,[0, 0.105, -pi/2, 0.0],0,group.leftArm},...
        {'leftWristYaw',types.joint,11,[ 0, 0.0, pi/2, 0],0,group.leftArm},...
        {'leftEE',types.joint,12,[0, 0, -pi/2, pi],0,group.leftArm},...
        ...
        {'leftPlastic',types.mount,13,[ 0, 0, -pi/2, pi],1,group.leftArm},...
        {'leftUpperPatch',types.patch,14,[ 0, 0, 0, 0],1,group.leftArm},...
        {'leftLowerPatch',types.patch,14,[ 0, 0, 0, 0],1,group.leftArm},...
        ...
        {'rightShoulderPitch',types.joint,1,[0, 0.1, -pi/2, 0],0,group.rightArm},...
        {'rightShoulderRoll',types.joint,17,[0, -0.098, pi/2, 0],0,group.rightArm},...
        {'rightElbowYaw',types.joint,18,[0, 0,  pi/2, pi/2],0,group.rightArm},...
        {'rightElbowRoll',types.joint,19,[0, 0.105, -pi/2, 0.0],0,group.rightArm},...
        {'rightWristYaw',types.joint,20,[ 0, 0, pi/2, 0],0,group.rightArm},...
        {'rightEE',types.joint,21,[0, 0, -pi/2, pi],0,group.rightArm},...
        ...
        {'rightPlastic',types.mount,22,[ 0, 0, -pi/2, pi],1,group.rightArm},...
        {'rightUpperPatch',types.patch,23,[ 0, 0, 0, 0],1,group.rightArm},...
        {'rightLowerPatch',types.patch,23,[ 0, 0, 0, 0],1,group.rightArm},...
        ...
        {'torsoPlastic',types.mount,1,[0,0,0,0],1,group.torso},...
        {'torsoLeftPatch',types.patch,26,[ 0, 0, 0, 0],1,group.torso},...
        {'torsoRightPatch',types.patch,26,[ 0, 0, 0, 0],1,group.torso}};
    for triangleId=hands_upper
        structure{end+1}={strcat('rightTriangle',num2str(triangleId)),types.triangle,24,[0,0,0,0],1,group.rightArm};
        structure{end+1}={strcat('leftTriangle',num2str(triangleId)),types.triangle,15,[0,0,0,0],1,group.leftArm};
    end
    for triangleId=hands_lower
        structure{end+1}={strcat('rightTriangle',num2str(triangleId)),types.triangle,25,[0,0,0,0],1,group.rightArm};
        structure{end+1}={strcat('leftTriangle',num2str(triangleId)),types.triangle,16,[0,0,0,0],1,group.leftArm};
    end
    ...
    for triangleId=head_right
        structure{end+1}={strcat('headTriangle',num2str(triangleId)),types.triangle,7,[0,0,0,0],1,group.head};
    end
    for triangleId=torso_left
        structure{end+1}={strcat('torsoTriangle',num2str(triangleId)),types.triangle,27,[0,0,0,0],1,group.torso};
    end
    for triangleId=torso_right
        structure{end+1}={strcat('torsoTriangle',num2str(triangleId)),types.triangle,28,[0,0,0,0],1,group.torso};
    end
